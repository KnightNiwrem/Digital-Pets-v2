...
export const SPECIES_DATA: Record<string, Species> = {
  starter_fire: {
    ...
    learnableMoves: [
      ...
      { moveId: 'fire_spin', learnStage: 'ADULT' as any, learnChance: 30 },
    ],
    ...
    abilities: [
      {
        ...
        effect: 'DAMAGE_REDUCTION' as any,
        value: 25,
      },
    ],
  ...
  starter_water: {
    ...
    learnableMoves: [
      ...
      { moveId: 'aqua_jet', learnStage: 'ADULT' as any, learnChance: 30 },
    ],
  ...
  starter_grass: {
    ...
    learnableMoves: [
      ...
      { moveId: 'solar_beam', learnStage: 'ADULT' as any, learnChance: 30 },
    ],
  ...
  sky_wing: {
    ...
    traits: {
      temperament: 'adventurous' as any,
      habitat: 'mountain' as any,
      activityPreference: 'diurnal' as any,
    },
    learnableMoves: [
      { moveId: 'gust', learnStage: 'HATCHLING' as any, learnChance: 100 },
      { moveId: 'wing_attack', learnStage: 'JUVENILE' as any, learnChance: 60 },
      { moveId: 'air_slash', learnStage: 'ADULT' as any, learnChance: 40 },
    ],
  ...
  rock_golem: {
    ...
    traits: {
      temperament: 'stoic' as any,
      habitat: 'cave' as any,
      activityPreference: 'nocturnal' as any,
    },
    learnableMoves: [
      { moveId: 'rock_throw', learnStage: 'HATCHLING' as any, learnChance: 100 },
      { moveId: 'stone_edge', learnStage: 'JUVENILE' as any, learnChance: 50 },
      { moveId: 'earthquake', learnStage: 'ADULT' as any, learnChance: 25 },
    ],
  ...
  thunder_cat: {
    ...
    traits: {
      temperament: 'hyperactive' as any,
      habitat: 'storm' as any,
      activityPreference: 'cathemeral' as any,
    },
    learnableMoves: [
      { moveId: 'thunder_shock', learnStage: 'HATCHLING' as any, learnChance: 100 },
      { moveId: 'thunderbolt', learnStage: 'JUVENILE' as any, learnChance: 40 },
      { moveId: 'thunder', learnStage: 'ADULT' as any, learnChance: 20 },
    ],
  ...
  dragon_lord: {
    ...
    traits: {
      temperament: 'proud' as any,
      habitat: 'volcano' as any,
      activityPreference: 'nocturnal' as any,
    },
    learnableMoves: [
      { moveId: 'dragon_breath', learnStage: 'HATCHLING' as any, learnChance: 100 },
      { moveId: 'dragon_claw', learnStage: 'JUVENILE' as any, learnChance: 60 },
      { moveId: 'dragon_pulse', learnStage: 'ADULT' as any, learnChance: 40 },
      { moveId: 'hyper_beam', learnStage: 'ADULT' as any, learnChance: 20 },
    ],
    ...
    abilities: [
      ...
      },
      {
        ...
        effect: 'BATTLE_START_DEBUFF' as any,
        value: 20,
      },
    ],
    careModifiers: {
