            ...
            {pet.poopCount > 0 && (
              <div className="text-center mb-4">
                <div className="inline-flex gap-2">
                  ...
                  {pet.poopCount > 5 && <span className="text-gray-600">+{pet.poopCount - 5}</span>}
                </div>
              </div>
            )}
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                />
                <ActionButton
                  onClick={() => onUserAction('SAVE_GAME')}
                  icon="💾"
                  label="Save"
                  disabled={false}
                />
            ...
            <div className="bg-white rounded-2xl shadow-lg p-6">
              ...
              <div className="grid grid-cols-3 gap-3">
                <NavButton onClick={() => console.log('Inventory')} icon="🎒" label="Inventory" />
                <NavButton onClick={() => console.log('Shop')} icon="🛍️" label="Shop" />
                <NavButton onClick={() => console.log('Travel')} icon="🗺️" label="Travel" />
                <NavButton onClick={() => console.log('Activities')} icon="🎯" label="Activities" />
